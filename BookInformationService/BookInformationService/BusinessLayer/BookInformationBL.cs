...
using BookInformationService.Kafka;
...
namespace BookInformationService.BusinessLayer
{
    public class BookInformationBL : IBookInformationBL
    {
        ...
        public BookInformationBL(ILogger<object> logger, IBookInformationDL bookInformationDL, IMapper mapper, KafkaConfig kafkaConfig)
        {
            _logger = logger;
        ...
        private async Task UpdateBookAvailability()
        {
            List<string> messages = _kafkaConfig.Receive(_logger);
